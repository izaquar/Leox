...
class pluginController:
    ...
    def load_menu (self):
        ...
        if sys.platform == "win32":
            table = (
                ("Console",None,self.launchCmd),
                ("Explorer",None,self.launchExplorer))
        else:
        ...
        c.frame.menu.createNewMenu("Launch")#,"top")
        c.frame.menu.createMenuItemsFromTable("Launch",table)#,dynamicMenu=True)
