...
class ConfigClass:
    ...
    class LangPageClass(PageClass):
        ...
        #@-others
    #@-node:AGP.20230214111049.316: class LangPageClass
    #@+node:AGP.20230214111049.320:WrapToPython
...
class ParserClass:
    ...
    class FUNCRULE:
        ...
        #@-node:AGP.20230214111049.432:Match
        #@+node:AGP.20230214111049.433:OnMatch
        def OnMatch(self,mo,node):
    ...
    #@nonl
    #@-node:AGP.20230214111049.458:__init__
    #@+node:AGP.20230214111049.459:Declare
    def Declare(self,text):
        ...
        for l in lines:
            ...
            for d in self.DEC_PROC_LIST:
                d(l+"\n")
    #@-node:AGP.20230214111049.459:Declare
    #@+node:AGP.20230214111049.460:Define
    ...
    def WriteOthers(self,node,w):
        ...
        return True
    #@-node:AGP.20230214111049.461:WriteOthers
    #@+node:AGP.20230214111049.462:WriteOthers_asm
    ...
    #@nonl
    #@-node:AGP.20230214111049.466:ParseNode
    #@+node:AGP.20230214111049.467:OnParseNode
    def OnParseNode(self,node,back=False):
        ...
        for opn in self.OPN_PROC_LIST:
            opn(node,back)
    #@-node:AGP.20230214111049.467:OnParseNode
    #@+node:AGP.20230214111049.468:OnFunc
    def OnFunc(self,mo):
        pass
    #@nonl
    #@-node:AGP.20230214111049.468:OnFunc
...
class LocatorClass(ParserClass):
    ...
    #@nonl
    #@-node:AGP.20230214111049.507:LocateDef
    #@+node:AGP.20230214111049.508:LocateDoc
    ...
    #@-others
#@-node:AGP.20230214111049.503:LocatorClass
#@+node:AGP.20230214111049.509:PyWrapperClass
class PyWrapperClass(ParserClass):
    #@    @+others
    #@+node:AGP.20230214111049.510:__init__
    def __init__(self,cc):
        ...
        #g.trace('WriteClass.Result',self.Result)
    #@-node:AGP.20230214111049.510:__init__
    #@+node:AGP.20230214111049.511:OnWrapStart
    ...
    #@nonl
    #@-node:AGP.20230214111049.511:OnWrapStart
    #@+node:AGP.20230214111049.512:OnWrapEnd
    def OnWrapEnd(self):
    ...
    #@nonl
    #@-node:AGP.20230214111049.512:OnWrapEnd
    #@+node:AGP.20230214111049.513:OnFunc
    def OnFunc(self,mo):
        types = {
            "char":"b",
            "short":"s",
