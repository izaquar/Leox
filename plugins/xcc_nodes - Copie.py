#@+leo-ver=4-thin
#@+node:agp.20070109212533:@thin xcc_nodes.py
...
#@+middle:ekr.20060513153648:Documentation
#@+node:agp.20070505102536:<< what was redid/undid >>
#@@nocolor
#@+at
# 
...
#@-at
#@-node:ekr.20060513122450.3:Future Features
#@+node:agp.20060520123624:Tracing Problems
#@+at
...
#@-at
#@-node:agp.20060520123624:Tracing Problems
#@+node:agp.20061018012249:XCC Explanation
#@+at
# UNFINISHED
# 
...
# 
#@-at
#@+node:agp.20061018014003:The Three Distinctive Nodes
#@+at
...
#@nonl
#@-node:agp.20061018014003:The Three Distinctive Nodes
#@+node:agp.20061018014003.1:The Parser
#@+at
...
#@+node:agp.20070207022338:StrToBool
...
#@-node:ekr.20060513122450.34:Error
#@+node:ekr.20060513122450.38:GetDictKey
...
def IsXcc(node):
	...
	if node.headString()[0:5] == "@xcc ":
		...
		return False
#@-node:ekr.20060513122450.390:IsXcc
#@+node:agp.20060520121647:HasXccDict
def HasXccDict(v):
...
#@nonl
#@-node:ekr.20060513122450.35:Warning
#@+node:agp.20060817135048:C++ parsing
#@+node:agp.20060817135048.1:SplitFunc
def SplitFunc(head):
    params_e = head.rfind(")")
    if params_e > -1:
...
#@nonl
#@-node:agp.20060817135048.1:SplitFunc
#@+node:agp.20060818115955:SplitParams
...
class controllerClass:
    ...
    #@    @+others
    #@+node:ekr.20060513142641.2:__init__
    def __init__ (self,c):
        ...
        #@nonl
        #@-node:ekr.20060513122450.8:Browse Info
        #@+node:agp.20060727203322:Write Info
        ...
        #@nonl
        #@-node:ekr.20060513122450.13:Options
        #@+node:agp.20060521091102:Code Decorations
        ...
        #@nonl
        #@-node:agp.20060521091102:Code Decorations
        #@+node:agp.20060520150529:Leo's Controls shortcut
    ...
    #@nonl
    #@-node:ekr.20060513142641.2:__init__
    #@+node:ekr.20060513152023:Event handlers
    ...
    #@nonl
    #@-node:ekr.20060513122450.392:UpdateProcess
    #@+node:agp.20060520141401:ReplaceVars
    ...
    #@nonl
    #@-node:agp.20060520141401:ReplaceVars
    #@+node:agp.20060521153231:GetUnknownAttributes
    ...
    #@nonl
    #@-node:agp.20060521153231:GetUnknownAttributes
    #@+node:agp.20070413213649:HideWidgets
    ...
    def cGetDict(self,node=None,create=True):#Get xcc child dict alias "xcc_child_cfg" in ua	
    ...
    #@+node:agp.20070206130657:ParseTree
    def ParseTree(self):
        p = ParserClass(self)
        p.Parse()
    #@nonl
    ...
    #@nonl
    #@-node:agp.20061016210621:Link
    #@+node:agp.20061016211035:LkrCmd
    def LkrCmd(self):
        ...
        #@    @+others
        #@+node:agp.20061016211035.1:_LIBPATHS_
        s = cc.LKR.get("Library path",'')
        if s:
            sym = s
            paths = cc.LKR.get("Library search paths",'').splitlines()
        ...
        #@nonl
        #@-node:agp.20061016211035.1:_LIBPATHS_
        #@+node:agp.20061016211035.2:_LIBRARIES_
        s = cc.LKR.get("Use library")
        if s:
            sym = s
            libs = cc.LKR.get("Used libraries",'').split()
        ...
        #@nonl
        #@-node:agp.20061016211035.2:_LIBRARIES_
        #@+node:agp.20061016211035.3:_BUILD_
        if cc.OUTEXT == "exe":
            s = cc.LKR.get("Build exe")
            if s: cmd = cmd.replace("_BUILD_",s)
    ...
    def Execute(self):    
        ...
        return ProcessClass.QueueProcess(process)
    #@-node:ekr.20060513122450.338:Execute
    #@+node:agp.20061016210621.1:RunTool
    ...
    #@-node:ekr.20060513122450.343:CplEnd
    #@-node:ekr.20060513122450.339:Compiler Events
    #@+node:agp.20070205104231:Linker Events
    #@+node:agp.20070205104231.1:LkrStart
    def LkrStart(self):
    ...
    #@-node:agp.20070205104231.1:LkrStart
    #@+node:agp.20070205104231.2:LkrOut
    ...
    #@-node:agp.20070205104231.2:LkrOut
    #@+node:agp.20070205104231.3:LkrErr
    ...
    #@nonl
    #@-node:agp.20070205104231.3:LkrErr
    #@+node:agp.20070205104231.4:LkrEnd
...
#@+node:ekr.20060513122450.346:DbgTaskClass
class DbgTaskClass:
    #@    @+others
...
#@nonl
#@-node:ekr.20060513122450.346:DbgTaskClass
#@+node:ekr.20060513122450.349:OutputTaskClass
...
#@nonl
#@-node:ekr.20060513122450.349:OutputTaskClass
#@+node:ekr.20060513122450.353:TargetPidTaskClass
...
#@nonl
#@-node:ekr.20060513122450.353:TargetPidTaskClass
#@+node:ekr.20060513122450.357:BreakTaskClass
...
#@nonl
#@-node:ekr.20060513122450.357:BreakTaskClass
#@+node:ekr.20060513122450.361:RegExpTaskClass
...
#@nonl
#@-node:ekr.20060513122450.361:RegExpTaskClass
#@+node:ekr.20060513122450.365:WatchTaskClass
...
#@nonl
#@-node:ekr.20060513122450.365:WatchTaskClass
#@+node:agp.20070413223141:DasmTaskClass
class DasmTaskClass(DbgTaskClass):
    #@    @+others
    #@+node:agp.20070413223141.1:__init__
    def __init__(self,cc,index=0):
        ...
        self.Inited = False
    #@-node:agp.20070413223141.1:__init__
    #@+node:agp.20070413223141.2:Cancel
    def Cancel(self):
        cc = self.cc
        if self.Send in cc.DBG_SD:
            cc.DBG_SD.remove(self.Send)
    ...
    #@-node:agp.20070413223141.2:Cancel
    #@+node:agp.20070413223141.3:Send
    def Send(self):
        cc = self.cc    
    ...
    #@nonl
    #@-node:agp.20070413223141.3:Send
    #@+node:agp.20070413223141.4:Receive
    def Receive(self,line):
        cc = self.cc
        if cc.DBG_PROMPT == False:	
            self.Buffer += line
    ...
    #@nonl
    #@-node:agp.20070413223141.4:Receive
    #@+node:agp.20070413224924:OnPrompt
    def OnPrompt(self):
        cc = self.cc
...
#@nonl
#@-node:agp.20070413223141:DasmTaskClass
#@+node:ekr.20060513122450.371:QueryGoTaskClass
...
#@nonl
#@-node:ekr.20060513122450.371:QueryGoTaskClass
#@+node:ekr.20060513122450.375:BreakIdTaskClass
...
class ProcessClass:
    ...
    #@nonl
    #@-node:ekr.20060513122450.51:Update
    #@+node:agp.20061016193303:QueueProcess
    def QueueProcess(p):
        if len(ProcessClass.List) == 0:
            ok = p.Open()
            if ok:
...
class ConfigClass:
    ...
    class PageClass(Tk.Canvas):
        ...
        class CHECK:
            ...
            def Set(self,value):
                ...
                self.UpdDpd()
            #@-node:ekr.20060513122450.58:Set
            #@+node:agp.20060728213822:UpdDpd
            def UpdDpd(self):
    ...
    class CplPageClass(PageClass):
        ...
        #@-others
    #@-node:ekr.20060513122450.99: class CplPageClass
    #@+node:agp.20061016193833: class LkrPageClass
    class LkrPageClass(PageClass):
        #@    @+others
        #@+node:agp.20061016193833.1:__init__
        def __init__(self,cc):
        ...
        #@nonl
        #@-node:agp.20061016193833.1:__init__
        #@+node:agp.20061016193833.2:Browse
        def Browse(self):
            try:
                for o in self.Objects:
        ...
        #@nonl
        #@-node:agp.20061016193833.2:Browse
        #@+node:agp.20061016193833.3:AddPath
        def AddPath(self,name):
            try:
                d = tkFileDialog.askdirectory()
                if d != "":
        ...
        #@nonl
        #@-node:agp.20061016193833.3:AddPath
        #@+node:agp.20061016193833.4:CreateObjects
        def CreateObjects(self,master): #must overide
        
            #@    @+others
            #@+node:agp.20061016193833.5:Executable
            x=10
            y=10
            text_w = 350
            text_h = 80
            ...
            #@nonl
            #@-node:agp.20061016193833.5:Executable
            #@+node:agp.20061016193833.6:Arguments
            self.AddSep()
            #-------------------------------------------------
            ...
            #@nonl
            #@-node:agp.20061016193833.6:Arguments
            #@+node:agp.20061016193833.7:Paths
            self.AddSep()
            ...
            #@nonl
            #@-node:agp.20061016193833.7:Paths
            #@+node:agp.20061016193833.8:Symbols
            ww =19
            self.AddSep()
            #------------------------------------------------------
            lf = Tk.Frame(master,relief='flat',bd=2)
            ...
            #@nonl
            #@-node:agp.20061016193833.8:Symbols
            #@+node:agp.20061016193833.9:Error Detection
            # ------------------
            self.AddSep()
            e = self.ENTRY(master,"Error detection",x=5,y=self.H,w=350,re=True)
            self.HELP(master,boxtitle="Error detection info",msg=CplArgumentsHelp,x=360,y=self.H)
    ...
    class ExePageClass(PageClass):
        ...
        def CreateObjects(self,master):#must overide
            ...
            #@-node:ekr.20060513122450.124:Args
            #@+node:agp.20070413002425:Piping
            self.AddSep()
            self.AddObject(self.ENTRY(master,"Pipe eol",x=5,y=self.H))
            #@nonl
            #@-node:agp.20070413002425:Piping
    ...
    class OptPageClass(PageClass):
        ...
        def CreateObjects(self,master): # must overide
            ...
            #@    @+others
            #@+node:ekr.20060513122450.97:Files Creation
            s1 = self.CHECK(master,"Create files",x=5,y=self.H)
            self.AddObject(s1)
            ...
            #@nonl
            #@-node:ekr.20060513122450.97:Files Creation
            #@+node:agp.20061016183631:Build
            self.AddSep(length=350)
            ...
            #@-node:agp.20061016183631:Build
            #@+node:agp.20061016183631.1:Execution
            self.AddSep(length=350)
        ...
        #@-others
    #@-node:ekr.20060513122450.94: class OptPageClass
    #@+node:agp.20061016223957: class LangPageClass
    class LangPageClass(PageClass):
    
        #@    @+others
        #@+node:agp.20061016223957.1:__init__
        def __init__(self,cc):
            
            self.cc = cc
            ConfigClass.PageClass.__init__(self,cc,"Language")
        #@-node:agp.20061016223957.1:__init__
        #@+node:agp.20061016223957.2:CreateObjects
        def CreateObjects(self,master): # must overide
        
            #@    @+others
            #@+node:agp.20061016223957.3:Language
            e1 = self.ENTRY(master,"Language",x=7,y=15)
    ...
    #@-node:ekr.20060513122450.86:Show
    #@+node:agp.20070506114337:WrapToPython
    def WrapToPython(self):
        PyWrapperClass(self.cc)
    #@nonl
    #@-node:agp.20070506114337:WrapToPython
    #@-others
#@nonl
...
class WatcherClass(Tk.Frame):
    ...
    #@-others
#@-node:ekr.20060513122450.166:class WatcherClass
#@+node:agp.20070413211057:class DasmClass
class DasmClass(Tk.Frame):

    #@    @+others
    #@+node:agp.20070413211057.1:__init__
    def __init__(self,cc):
    ...
    #@nonl
    #@-node:agp.20070413211057.1:__init__
    #@+node:agp.20070413211057.6:Hide
    def Hide(self):
        try:
            cc = self.cc
            self.pack_forget()
    ...
    #@nonl
    #@-node:agp.20070413211057.6:Hide
    #@+node:agp.20070413211057.7:Show
    def Show(self):
        try:
            cc = self.cc
            cc.HideWidgets()
    ...
    #@nonl
    #@-node:agp.20070413211057.7:Show
    #@+node:agp.20070413211057.8:Sync
    def Sync(self):
...
class BreakbarClass(Tk.Text):
    ...
    #@-others
#@-node:ekr.20060513122450.175:class BreakbarClass
#@+node:agp.20060729210351:class DocEditClass
class DocEditClass(Tk.Text):
    #@    @+others
    #@+node:agp.20060729210351.1:__init__
    def __init__(self,cc):
        self.cc = cc
        ...
        #@    @+others
        #@+node:agp.20060730222036:TopBar
        ...
        #@nonl
        #@-node:agp.20060730222036:TopBar
        #@+node:agp.20060730222036.1:New Topic
        ...
        #@nonl
        #@-node:agp.20060730222036.1:New Topic
        #@+node:agp.20060730222036.2:Use Head
        ...
        #@nonl
        #@-node:agp.20060730222036.2:Use Head
        #@+node:agp.20070519110410:Pre Format
        ...
        self.visible = False
    #@-node:agp.20060729210351.1:__init__
    #@+node:agp.20060729210351.2:Show
    def Show(self):
        try:
            cc = self.cc
            cc.HideWidgets()
    ...
    #@nonl
    #@-node:agp.20060729210351.2:Show
    #@+node:agp.20060729210351.3:Hide
    def Hide(self):
        try:
            cc = self.cc
    ...
    #@nonl
    #@-node:agp.20060729210351.3:Hide
    #@+node:agp.20060729215923:LoadFromNode
    def LoadFromNode(self):
        cc = self.cc
        self.delete(1.0,'end')
        if cc.CHILD_DICT:        
    ...
    #@nonl
    #@-node:agp.20060729215923:LoadFromNode
    #@+node:agp.20060729215923.1:SaveToNode
    def SaveToNode(self):
        cc = self.cc  
        if cc.CHILD_DICT:
    ...
    #@nonl
    #@-node:agp.20060729215923.1:SaveToNode
    #@+node:agp.20060729230915:OnKeyRelease
...
#@nonl
#@-node:agp.20060729210351:class DocEditClass
#@+node:agp.20061016184055:HELP
#@+node:agp.20061014201056:Options
#@+node:agp.20061014201056.1:BuildSequence
...
#@-node:agp.20061014201056.1:BuildSequence
#@-node:agp.20061014201056:Options
#@+node:ekr.20060513122450.140:Compiler
...
#@-node:ekr.20060513122450.150:ErrorDetectionHelp
#@-node:ekr.20060513122450.140:Compiler
#@+node:ekr.20060513122450.130:Debugger
...
#@+node:ekr.20060513122450.212:ParserClass
class ParserClass:
    ...
    #@nonl
    #@-node:ekr.20060513122450.214:LoadCppRules
    #@+node:agp.20060821215115:ATRULE
    class ATRULE:
        #@    @+others
        #@+node:agp.20060821215115.2:Match
        def Match(self,head):
            if head.startswith("@"):
                return True
            return None
        ...
        #@-node:agp.20060821215115.2:Match
        #@+node:agp.20060821215115.3:OnMatch
    ...
    class FUNCRULE:
        ...
        #@nonl
        #@-node:ekr.20060513122450.224:DeclareFunc
        #@+node:agp.20060817145617:DefineFunc
    ...
    #@nonl
    #@-node:ekr.20060513122450.233:FUNCCOMMENTRULE
    #@+node:AGP.20201210160828:FUNCASMRULE
    class FUNCASMRULE:
        #@    @+others
        #@+node:AGP.20201210160828.1:__init__
        def __init__(self,Parser):
        ...
        #@nonl
        #@-node:AGP.20201210160828.1:__init__
        #@+node:AGP.20201210160828.2:Match
        def Match(self,head):
            return self.Matcher.search(head)
        #@-node:AGP.20201210160828.2:Match
        #@+node:AGP.20201210160828.3:OnMatch
        def OnMatch(self,mo,node):
    ...
    def WriteOthers(self,node,w):
        ...
        return True
    #@-node:ekr.20060513122450.254:WriteOthers
    #@+node:AGP.20201210161232:WriteOthers_asm
    def WriteOthers_asm(self,node,w):
    ...
    #@-node:ekr.20060513122450.246:PopBodyLine
    #@+node:ekr.20060513122450.255:Parse
    def Parse(self):
    ...
    def OnParseNode(self,node,back=False):
        ...
        for opn in self.OPN_PROC_LIST:
            opn(node,back)
    #@-node:ekr.20060513122450.256:OnParseNode
    #@+node:agp.20070506104706:OnFunc
    def OnFunc(self,mo):
        pass
    #@nonl
    #@-node:agp.20070506104706:OnFunc
    ...
    #@-node:ekr.20060513122450.253:TabWrite
    #@+node:AGP.20201210161442:TabWrite_asm
    ...
    #@-node:AGP.20201210161442:TabWrite_asm
    #@-node:ekr.20060513122450.248:Tabing
    #@+node:agp.20070206234855:Documentation
    ...
    #@nonl
    #@-node:ekr.20060513122450.244:Docum
    #@+node:agp.20060724212618:PushDoc
    def PushDoc(self,name,intro=True):
        self.DOC_NAMES.append(name)
        
    #@nonl
    #@-node:agp.20060724212618:PushDoc
    #@+node:agp.20060724213508:PopDoc
    def PopDoc(self):
        self.DOC_NAMES.pop()
    ...
    #@nonl
    #@-node:agp.20060724213508:PopDoc
    #@+node:agp.20060724215513:DocName
    ...
    #@nonl
    #@-node:agp.20060724215513:DocName
    #@+node:agp.20070206234855.1:StartDoc
    ...
    #@-node:agp.20070206234855.1:StartDoc
    #@+node:agp.20070206234855.2:EndDoc
...
#@-node:ekr.20060513122450.212:ParserClass
#@+node:ekr.20060513122450.259:WriterClass
class WriterClass(ParserClass):
    ...
    #@-node:ekr.20060513122450.260:__init__
    #@+node:agp.20060724215520:PushDoc
    def PushDoc(self,name,intro=True):
        cc = self.cc    
        self.DocTab += 5
        self.DOC_NAMES.append(name)
    ...
    #@-node:agp.20060724215520:PushDoc
    #@+node:agp.20060724221801:PopDoc
    def PopDoc(self):
    ...
    #@nonl
    #@-node:ekr.20060513122450.262:OnWriteEnd
    #@+node:agp.20060726210108:CreateBaseDoc
    ...
    #@-others
#@-node:ekr.20060513122450.259:WriterClass
#@+node:ekr.20060513122450.263:BreakFinderClass
...
#@nonl
#@-node:ekr.20060513122450.270:SeekErrorClass
#@+node:ekr.20060513122450.275:LocatorClass
class LocatorClass(ParserClass):
    ...
    #@nonl
    #@-node:ekr.20060513122450.278:LocateDec
    #@+node:agp.20060725012944:LocateDef
    ...
    #@nonl
    #@-node:agp.20060725012944:LocateDef
    #@+node:ekr.20060513122450.279:LocateDoc
    def LocateDoc(self,text):
        if self.DO_PARSE:
            if self.CURRENT_NODE == self.LOCATE_NODE:
                if self.CURRENT_BODY_LINE == self.LOCATE_BODY_LINE:
    ...
    #@-others
#@-node:ekr.20060513122450.275:LocatorClass
#@+node:agp.20070506104706.1:PyWrapperClass
class PyWrapperClass(ParserClass):
    #@    @+others
    #@+node:agp.20070506104706.2:__init__
    def __init__(self,cc):
        ...
        #g.trace('WriteClass.Result',self.Result)
    #@-node:agp.20070506104706.2:__init__
    #@+node:agp.20070506104706.7:OnWrapStart
    def OnWrapStart(self):    
    ...
    #@nonl
    #@-node:agp.20070506104706.7:OnWrapStart
    #@+node:agp.20070506104706.8:OnWrapEnd
    def OnWrapEnd(self):
    ...
    #@nonl
    #@-node:agp.20070506104706.8:OnWrapEnd
    #@+node:agp.20070506114337.1:OnFunc
    def OnFunc(self,mo):
        types = {
            "char":"b",
            "short":"s",
...
#@-others
#@nonl
#@-node:agp.20070109212533:@thin C:\Program Files (x86)\Leo\plugins\xcc_nodes.py
#@-leo
