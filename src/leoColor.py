...
class baseColorizer:
    ...
    def enable (self):
        ...
        self.enabled=True
    #@-node:ekr.20050420083821:disable & enable
    #@+node:AGP.20240323143050:configure_tags()
    def configure_tags(self):
        theme = g.theme
        global default_colors_dict
        default_colors_dict = {
        # tag name      :(     option name,           default color),
        "comment"       :("comment_color",              theme['comment']),
        "cwebName"      :("cweb_section_name_color",     "red"),
        "pp"             :("directive_color",             theme['directive']),
        "docPart"        :("doc_part_color",              "red"),
        "keyword"        :("keyword_color",               theme['keyword']),
        "leoKeyword"     :("leo_keyword_color",           theme['accent']),
        "link"           :("section_name_color",          "red"),
        "nameBrackets"   :("section_name_brackets_color", "blue"),
        "string"         :("string_color",                theme['string']), # Used by IDLE.
        "name"           :("undefined_section_name_color","red"),
        "latexBackground":("latex_background_color","white"),
        }
        #print 'configure tags',theme['directive']
    ...
    def colorizeAnyLanguage (self,p,leading=None,trailing=None):
        ...
        try:
            ...
            #@+node:AGP.20240323151820:<< initialize ivars & tags >> colorizeAnyLanguage
            ...
            #@<< configure fonts >>
            #@+node:AGP.20240323150504.1:<< configure fonts >>
            ...
            #@nl
            #@<< configure tags >>
            #@+node:AGP.20240323150504.2:<< configure tags >>
            ...
            #@+node:AGP.20240323150504.3:<< configure language-specific settings >> colorizer
